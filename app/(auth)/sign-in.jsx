...
export default function SignIn() {
  ...
  return (
    <SafeAreaView style={{backgroundColor:COLORS.lightwhite, height:'100%'}}>
       ...
       <Text style={{color:COLORS.darkQoutes, fontSize:24, fontFamily:'Poppins-Regular', fontWeight:'690',marginTop:30, marginBottom:12}}>Log in or sign up to Presens</Text>
       <FormField title="Email" value={form.email} handleChangeText={(e) => setForm({...form, email:e})} otherStyles={{marginTop:7}} 
       ...
       {isSubmitting ? (
            ...
            <CustomButton title="Sign In" handlePress={submit} containerStyles={{ marginTop: 14 }} />
          )}
       ...
       <View style={{justifyContent:'center', flexDirection:'row', marginTop:20, gap:8}}>
                <Text style={{fontFamily:'Poppins-Regular', fontSize:16, color:COLORS.darkQoutes}}>Don't have an account?</Text>
                <Link href="/sign-up" style={{fontFamily:"Poppins-SemiBold", fontSize:16, color:COLORS.primary2}}>Sign Up</Link>
            </View>
        </View>
       </ScrollView>
    </SafeAreaView>
